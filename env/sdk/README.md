...
The tile demos (19-24) need a TornadoVM with `TileContext`; everything else is happy on the
released 6.0.0 SDK. That used to mean a second runner script and a hand-set `TORNADOVM_HOME`.
